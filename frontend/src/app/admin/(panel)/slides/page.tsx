      ...
      >
        ...
        <div className="flex gap-2">
          <button
            ...
            className="rounded-xl bg-gradient-to-r from-accent-gold to-accent-gold-hover px-5 py-2.5 text-sm font-extrabold text-background shadow-md hover:opacity-90 transition-all disabled:opacity-50 cursor-pointer"
          >
