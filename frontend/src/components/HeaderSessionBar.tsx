  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <Link
        ...
        className="sell-cta-pulse hidden sm:inline-flex items-center justify-center gap-1.5 rounded-xl bg-gradient-to-r from-accent-blue to-accent-blue px-3.5 py-2 text-xs font-extrabold uppercase tracking-wide text-background border border-accent-blue/30 hover:opacity-95 hover:scale-[1.02] active:scale-[0.98] transition-all"
      >
